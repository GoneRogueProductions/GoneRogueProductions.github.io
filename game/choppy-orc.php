...
$game = "Choppy Orc";
$long_desc = "None yet!\nHi!";
$code = "<script>document.querySelector('.game-container').style.aspectRatio = '16 / 9';</script><iframe src='/co/game.html' title='Choppy Orc' frameborder='0' style='border: none;'></iframe>";
