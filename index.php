...
<body id="darkTog">
    ...
    <div class="container">
        ...
        if (isset($_SESSION['game'])) {
            echo '<div class="continue-playing" onclick="window.location.href=\''.$_SESSION['game'][1].'\';">
            <h4>Hey there!</h4>
            <p>We\'ve held on to your game of <b>'.$_SESSION['game'][0].'</b>. Click anywhere on here to access it.</p>
        </div>';
        }
        ?>
        <div class="title">
